package spring.security.conquer.security.filter;
...
import spring.security.conquer.util.WebUtil;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        if (HttpMethod.POST.name().equals(request.getMethod()) || WebUtil.isAjax(request)) {
            ...
            if (StringUtils.hasText(accountDto.getUsername()) && StringUtils.hasText(accountDto.getPassword())) {
                return getAuthenticationManager().authenticate(new RestAuthenticationToken(accountDto.getUsername(), accountDto.getPassword()));
            }
